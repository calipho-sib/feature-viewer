...
function FeatureViewer(sequence, div, options) {
        ...
        function tooltip(selection) {
            ...
            selection.on('mouseover.tooltip', function (pD, pI) {
                ...
                .on('click', function (pD, pI) {
                    ...
                    if (CustomEvent) {
                        var event = new CustomEvent(self.events.FEATURE_SELECTED_EVENT, {detail: {start: pD.x, end: pD.y}});
                        document.dispatchEvent(event);
                        self.trigger(self.events.FEATURE_SELECTED_EVENT, {start: pD.x, end: pD.y});
    ...
    this.onFeatureSelected = function(listener) {
        document.addEventListener(self.events.FEATURE_SELECTED_EVENT, listener);
